...
int main()
{
	int numberSurveyed;
	int forHillary;
	int forDnald; //this line contains a spelling error such that the following uses of "forDonald" cannot function because the variable has not been defined.

	cout << "How many registered voters were surveyed? " //the semicolon at the end of this line was removed.
	cin >> numberSurveyed;
