...
int main()
{
	...
	double pctHillary = 10.0 * forHillary / numberSurveyed; //error was introduced here - this error is a simple typo where the additional 0 from 100.0 was dropped resulting in 10.0
